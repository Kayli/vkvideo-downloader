...
def extract_video_links(
    ...
    """
    Backward compatible function wrapper for Browser
    """
    browser = Browser(headless=headless, timeout=timeout)
    return browser.extract_video_links(url)
...
def extract_videos_from_urls(
    ...
    return browser.extract_videos_from_urls(urls)
